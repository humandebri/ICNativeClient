...
verify_binary \
  arm64 \
  "$bundle/ic-candid-swift-bindgen-$expected_version-macos-arm64/bin/ic-candid-swift-bindgen"
verify_binary \
  x86_64 \
  "$bundle/ic-candid-swift-bindgen-$expected_version-macos-x86_64/bin/ic-candid-swift-bindgen"
